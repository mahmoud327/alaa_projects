...
@section('content')
    ...
    <section class="contact">
        <div class="container" data-aos="zoom-in" data-aos-duration="2000">
            ...
            <div class="row contact-info contact-detel">
                <div class="col-lg-3 col-md-4 col-sm-12 detels">
                    <div class="card">
                        <p style="background-color: #e9f6fd ; border-radius: 5px 5px 0 0;">رقم التواصل</p>
                        <div class="number" style="transform: translateY(23px)">
                            <ul class="number-contactUs d-flex justify-content-between gap-3 p-0 m-auto">
                                <li class="p-2">
                                ...
                                <li class="mx-2 p-2">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                ...
                "
                            class="py-1 sochial">+966 555549743</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-12 detels">
                    <div class="card">
                        <p
                            style="background-color: #e9f6fd ;    border-radius: 5px 5px 0 0;    border-radius: 5px 5px 0 0;">
                            البريد
                            الإلكتروني</p>
                        <div class="number" style="transform: translateY(23px)">
                            <ul class="number-contactUs d-flex justify-content-between gap-3 p-0 m-auto">
                                <li class="p-2">
                                    <img src="{{ asset('website/img/envelope.png ') }}" alt="" width="25">
                                </li>
                            </ul>
                        </div>
                  ...
                  background-color: #e9f6fd;
                "
                            class="py-1 sochial">info@AlaaAzani.com
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-12 detels">
                    <div class="card">
                        <p style="background-color: #e9f6fd;    border-radius: 5px 5px 0 0;">التواصل الإجتماعي</p>
                        <div class="number">
                            <ul
                                class="number-contactUs list-unstyled social d-flex flex-wrap p-0 m-0 justify-content-center">
                                <li class="m-1">
                                    <a href="https://www.snapchat.com/add/AlaaAzani" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                                ...
                                <li class="m-1">
                                    <a href="https://www.tiktok.com/@AlaaAzani" target="_blank">
                                ...
                                <li class="m-1">
                                    <a href="https://www.instagram.com/AlaaAzani" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                                ...
                                <li class="m-1">
                                    <a href="https://www.youtube.com/c/AlaaAzani" target="_blank"><svg
                                ...
                                <li class="m-1">
                                    <a href="https://www.pinterest.com/alaaazani" target="_blank"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                                ...
                                <li class="m-1">
                                    <a href="https://www.facebook.com/AlaaAzani" target="_blank"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                                ...
                                <li class="m-1">
                                    <a href="https://twitter.com/AlaaAzani" target="_blank"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                                ...
                                <li class="m-1">
                                    <a href="https://t.me/AlaaAzani" target="_blank"><svg width="24px" height="24px"
                        ...
                        ">
                                ...
                                <li class="m-1">
                                    <a href="https://www.linkedin.com/in/AlaaAzani" target="_blank"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                                ...
                                <li class="m-1">
                                    <a href="https://www.behance.net/AlaaAzani" target="_blank"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#fff"
                ...
                <div class="form">
                    <form method="POST" action="{{route('contact-us.store')}}">
                      ...
                      /> -->
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <label for="address">الموضوع</label>
                                <input type="text" name="subject" class="form-control" id="address" required />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
