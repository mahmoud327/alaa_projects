...
<section class="header">
  ...
  <section class="blogcontent">
    <div class="container">
      ...
      <div class="content">
        <h2>البرمجة الشيئية</h2>
        <div class="text">
          <p>
            بعض المصطلحات في عالم التقنية ومعناها بعض المصطلحات في عالم
            التقنية ومعناها بعض المصطلحات في عالم التقنية ومعناها
          </p>
        </div>
      </div>
      <div class="content">
        <h2>اللغات الاساسيه</h2>
        <div class="text">
          <h5>html</h5>
          <p>
            بعض المصطلحات في عالم التقنية ومعناها بعض المصطلحات في عالم
            ...
            <div class="share">
                ...
                <div class="icon">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 2859 3333" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd">
                      <path fill="#fff" d="M2081 0c55 473 319 755 778 785v532c-266 26-499-61-770-225v995c0 1264-1378 1659-1932 753-356-583-138-1606 1004-1647v561c-87 14-180 36-265 65-254 86-398 247-358 531 77 544 1075 705 992-358V1h551z"></path>
                    </svg>
      ...
      <div class="contentBlog blog contact">
        <div class="data">
          <div class="d-flex align-items-center my-2">
            <img  class=""src="imgs/sites-idea.png" alt="" width="20">
                  ...
                  <div class="gallery-card sites">
                      <div class="">
                          ...
                          <div class="image">
                              ...
                              <img src="imgs/web-design.png" alt="gallery-1" class="img-fluid">
                              <div class="overlay">
                                  <a href="blod_content681a.html">للتفاصيل </a>
                              </div>
                          </div>
                          <div class="galleryCard-footer">
                              <p class="p-1 m-0"> بعض المصطلحات في عالم التقنية ومعناها</p>
                          </div>
                      </div>
                  </div>
              </div>
