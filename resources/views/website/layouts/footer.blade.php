    ...
    <div class="container">
        ...
        <div class="copyright text-center">
            ...
            <ul class="list-unstyled social">
                <span>تابعنا</span>
                <li><a href="https://wa.me/966555549743" target="_blank">
                ...
                <li><a href="https://www.tiktok.com/@AlaaAzani" target="_blank">
                ...
                <li><a href="https://www.instagram.com/AlaaAzani" target="_blank"><svg
                ...
                <li><a href="https://www.youtube.com/c/AlaaAzani" target="_blank"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path
                                d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
                        </svg></a></li>
                <li><a href="https://www.pinterest.com/alaaazani" target="_blank"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path
                ...
                <li><a href="https://twitter.com/AlaaAzani" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" viewBox="0 0 24 24">
                            <path
                                d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
                        </svg></a></li>
                <li><a href="https://t.me/AlaaAzani" target="_blank"><svg width="24px" height="24px"
                ...
                <li><a href="https://www.linkedin.com/in/AlaaAzani" target="_blank"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path
                                d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                        </svg></a></li>
                <li><a href="https://www.behance.net/AlaaAzani" target="_blank"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path
            ...
            <p>جميع الحقوق محفوظة لدى علاء عزاني للتقنية 2022 ©</p>
        </div>
    </div>
</section>
<section class="btn-top p-0">
    <i class="fa-solid fa-angle-up"></i>
</section>
<section class="social-contact">
    <ul class="menu-button social">
        <li>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="#fff"
                    d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981zm11.387-5.464c-.074-.124-.272-.198-.57-.347-.297-.149-1.758-.868-2.031-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414z" />
        ...
        <li>
            ...
            <svg viewBox="0 0 26 26" width="24" height="24" xml:space="preserve"
                xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M23.23 4H2.77C1.795 4 1 4.844 1 5.88v14.24C1 21.155 1.794 22 2.77 22h20.46c.976 0 1.77-.844 1.77-1.88V5.88C25 4.845 24.206 4 23.23 4zm-7.563 9L23.5 7.347v11.306L15.667 13zm7.562-7.5c.054 0 .108.032.155.08L13 13.076 2.616 5.581c.047-.049.101-.081.155-.081h20.458zM2.5 18.653V7.347L10.333 13 2.5 18.653zm.27 1.847c-.053 0-.107-.032-.154-.08l8.998-6.495.948.683c.022.017.048.023.072.037a.745.745 0 0 0 .365.105h.002a.745.745 0 0 0 .365-.105c.024-.014.05-.02.072-.037l.947-.683 9 6.494c-.048.049-.102.081-.156.081H2.771z"
                    fill="#ffffff" class="fill-1d1d1b"></path>
            </svg>
        </li>
...
<div class=" loder">
    ...
    <div class="hexagons">
        <div class="hexagons__row">
            <div class="hexagons__cell hexagons__cell--1"></div>
            <div class="hexagons__cell hexagons__cell--2"></div>
        </div>
        <div class="hexagons__row">
            <div class="hexagons__cell hexagons__cell--6"></div>
            <div class="hexagons__cell hexagons__cell--7"></div>
            <div class="hexagons__cell hexagons__cell--3"></div>
        </div>
        <div class="hexagons__row">
            <div class="hexagons__cell hexagons__cell--5"></div>
            <div class="hexagons__cell hexagons__cell--4"></div>
        </div>
    </div>
</div>
