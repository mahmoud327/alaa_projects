...
<div class="row">
                            ...
                            @foreach ($teams as $team )
                                <tr data-id="{{ $team->id }}">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-toggle="modal" href="#exampleModal2{{$team->id}}" title="edit">
                                ...
                                @include('admin.my-teams.delete_modal' ,['team'=>$team])
                                @include('admin.my-teams.edit_modal',['team'=>$team])
                            @endforeach
                        </tbody>
                    </table>
                    {{ $teams->links() }}
    ...
    @include('admin.my-teams.add_modal')
