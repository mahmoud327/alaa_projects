    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                    ...
                    <a class="btn btn-outline-primary" href="{{route('admin.blogs.create')}}">Add blog</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody class="tr">
                            @foreach ($blogs as $blog )
                                <tr>
                                    ...
                                    <td>{{ $blog->title }}</td>
                                     <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-toggle="modal" href="#exampleModal2{{$blog->id}}" title="edit">
                                            <i class="las la-pen"></i>
                                        </a>
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal" href="#modaldemo9{{$blog->id}} " title="delete">
                                            delete
                                        </a>
                                    </td>
                                </tr>
