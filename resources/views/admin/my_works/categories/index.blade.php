...
<div class="row">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody class="tr">
                            @foreach ($categories as $category )
                                ...
                                @include('admin.my_works.categories.delete_modal' ,['category'=>$category])
                                @include('admin.my_works.categories.edit_modal',['category'=>$category])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('admin.my_works.categories.add_modal')
